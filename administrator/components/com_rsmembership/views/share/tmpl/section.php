...
function submitbutton()
{
	...
	rsmembership_submit_form_ajax('addmembershipsections');
	<?php } else { ?>
	rsmembership_submit_form_ajax('addextravaluesections');
	<?php } ?>
...
<form action="<?php echo JRoute::_('index.php?option=com_rsmembership&view=share&layout=section&tmpl=component&'.$this->what.'='.$this->id); ?>" method="post" name="adminForm">
	...
	<div id="editcell1">
		<table class="adminlist">
			...
			<tr>
				...
				<th width="20"><input type="checkbox" name="toggle" value="" onclick="checkAll(<?php echo count($this->sections); ?>);"/></th>
	...
	<input type="hidden" name="layout" value="section" />
