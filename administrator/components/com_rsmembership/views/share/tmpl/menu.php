...
function submitbutton()
{
	...
	rsmembership_submit_form_ajax('addmembershipmenus');
	<?php } else { ?>
	rsmembership_submit_form_ajax('addextravaluemenus');
	<?php } ?>
...
<form action="<?php echo JRoute::_('index.php?option=com_rsmembership&view=share&layout=menu&tmpl=component&'.$this->what.'='.$this->id); ?>" method="post" name="adminForm">
	...
	<div id="editcell1">
		<table class="adminlist">
			...
			<tr>
				...
				<th><?php echo JHTML::_('grid.sort', JText::_('Menu Type'), 'menutype', $this->sortOrder, $this->sortColumn); ?></th>
	...
	<input type="hidden" name="layout" value="menu" />
