...
function submitbutton()
{
	...
	rsmembership_submit_form_ajax('addmembershipcategories');
	<?php } else { ?>
	rsmembership_submit_form_ajax('addextravaluecategories');
	<?php } ?>
...
<form action="<?php echo JRoute::_('index.php?option=com_rsmembership&view=share&layout=category&tmpl=component&'.$this->what.'='.$this->id); ?>" method="post" name="adminForm">
