...
<table class="adminlist" id="addextravaluefolders">
	...
	<tr>
		...
		<th width="100"><?php echo JText::_('RSM_TYPE'); ?></th>
	...
	?>
		<tr class="row<?php echo $k; ?>">
			...
			<a class="modal" rel="{handler: 'iframe', size: {x: 660, y: 475}}" href="<?php echo JRoute::_('index.php?option=com_rsmembership&view=share&layout=url&tmpl=component&extra_value_id='.$this->row->id.'&cid='.$row->id); ?>">index.php?option=<?php echo $row->params; ?></a></td>
			<?php } else { ?>
				<?php echo $row->params; ?>
			<?php } ?>
