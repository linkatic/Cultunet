...
<form action="<?php echo JRoute::_('index.php?option=com_rsmembership&task=elementmembership&tmpl=component'); ?>" method="post" name="adminForm">
	...
	<div id="editcell1">
		<table class="adminlist">
			...
			<tr>
				...
				<th><?php echo JHTML::_('grid.sort', 'RSM_MEMBERSHIP_PERIOD', 'period', $this->sortOrder, $this->sortColumn); ?></th>
	...
	<input type="hidden" name="view" value="elementmembership" />
