			...
			<tr>
				<td>
					...
					<div style="float: left">
						<div class="icon hasTip" title="<?php echo JText::_('RSM_TRANSACTIONS_DESC'); ?>">
					...
					<div style="float: left">
						<div class="icon hasTip" title="<?php echo JText::_('RSM_MEMBERSHIPS_DESC'); ?>">
					...
					<div style="float: left">
						<div class="icon hasTip" title="<?php echo JText::_('RSM_CATEGORIES_DESC'); ?>">
					...
					<div style="float: left">
						<div class="icon hasTip" title="<?php echo JText::_('RSM_MEMBERSHIP_EXTRAS_DESC'); ?>">
					...
					<div style="float: left">
						<div class="icon hasTip" title="<?php echo JText::_('RSM_MEMBERSHIP_UPGRADES_DESC'); ?>">
					...
					<div style="float: left">
						<div class="icon hasTip" title="<?php echo JText::_('RSM_PAYMENT_INTEGRATIONS_DESC'); ?>">
					...
					<div style="float: left">
						<div class="icon hasTip" title="<?php echo JText::_('RSM_FILES_DESC'); ?>">
					...
					<div style="float: left">
						<div class="icon hasTip" title="<?php echo JText::_('RSM_FILE_TERMS_DESC'); ?>">
					...
					<div style="float: left">
						<div class="icon hasTip" title="<?php echo JText::_('RSM_USERS_DESC'); ?>">
					...
					<div style="float: left">
						<div class="icon hasTip" title="<?php echo JText::_('RSM_FIELDS_DESC'); ?>">
					...
					<div style="float: left">
						<div class="icon hasTip" title="<?php echo JText::_('RSM_CONFIGURATION_DESC'); ?>">
					...
					<div style="float: left">
						<div class="icon hasTip" title="<?php echo JText::_('RSM_UPDATES_DESC'); ?>">
					...
					<div style="float: left">
						<div class="icon hasTip" title="<?php echo JText::_('RSM_GO_TO_FRONTEND_DESC'); ?>">
