...
<form action="<?php echo JRoute::_('index.php?option=com_rsmembership&view=categories'); ?>" method="post" name="adminForm">
	...
	?>
		<tr class="row<?php echo $k; ?>">
			...
			<td><a href="<?php echo JRoute::_('index.php?option=com_rsmembership&controller=categories&task=edit&cid='.$row->id); ?>"><?php echo $row->name != '' ? $row->name : JText::_('RSM_NO_TITLE'); ?></a></td>
