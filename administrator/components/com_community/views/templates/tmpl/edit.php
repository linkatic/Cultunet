...
<table width="100%">
	<tr>
		<td>
			<fieldset>
				<legend><?php echo JText::_('CC TEMPLATE INFO');?></legend>
				<table cellspacing="1" class="admintable">
				<tbody>
					<tr>
						<td valign="top" width="300" class="key"><?php echo JText::_('CC NAME');?></td>
						<td valign="top"><?php echo $this->template->info['name'] ? $this->template->info['name'] : JText::_('N/A');?></td>
					</tr>
					<tr>
						<td valign="top" width="300" class="key"><?php echo JText::_('CC DESCRIPTION');?></td>
...
<table width="100%">
	<tr>
		<td valign="top" width="50%">
			<fieldset>
				<legend><?php echo JText::_('CC PARAMETERS');?></legend>
				<?php
		...
		<td valign="top">
			<fieldset>
				<legend><?php echo JText::_('CC TEMPLATE FILE');?>		
				<div id="status"></div>
						...
						<td valign="top">
							<div>								
								<div id="templates-list">
									<h3><?php echo JText::_('CC SELECT FILE');?></h3>
									<select name="file" onchange="azcommunity.editTemplate('<?php echo $this->template->element; ?>',this.value,'<?php echo $this->template->override ? 1 : 0;?>');">
										<option value="none" selected="true"><?php echo JText::_('CC SELECT A FILE');?></option>
										<?php
								...
								<table class="adminform">
									...
									<tr>
										...
										<th width="5%" align="right">
											<input type="button" onclick="azcommunity.saveTemplateFile('<?php echo $this->template->override ? 1 : 0;?>')" value="<?php echo JText::_('Save');?>" />
										</th>
									</tr>
									<tr>
