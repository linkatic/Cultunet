...
<div>
	<?php echo JText::_('CC NOTE EVENT CREATION IS NOW ONLY AVAILABLE THROUGH THE FRONT END OF JOM SOCIAL'); ?>
</div>
<table class="adminform" cellpadding="3">
	<tr>
		...
		<span style="font-weight: bold;"><?php echo JText::_('CC VIEWING EVENTS BY CATEGORY'); ?>:
...
<table class="adminlist" cellspacing="1">
	<thead>
		<tr class="title">
			...
			<th width="15%" style="text-align: left;">
				<?php echo JHTML::_('grid.sort', JText::_('CC NAME'), 'a.title', $this->lists['order_Dir'], $this->lists['order'] ); ?>
			</th>
			<th style="text-align: left;">
				<?php echo JText::_('CC EVENT DESCRIPTION'); ?>
			</th>
			<th width="5%">
				<?php echo JHTML::_('grid.sort', JText::_('CC PUBLISHED'), 'a.published', $this->lists['order_Dir'], $this->lists['order'] ); ?>
			</th>
			<th width="5%">
				<?php echo JHTML::_('grid.sort', JText::_('CC INVITED GUEST'), 'a.invitedcount', $this->lists['order_Dir'], $this->lists['order'] ); ?>
			</th>
			<th width="10%">
				<?php echo JHTML::_('grid.sort', JText::_('CC CONFIRMED GUEST'), 'a.confirmedcount', $this->lists['order_Dir'], $this->lists['order'] ); ?>
			</th>
		</tr>
	</thead>
	<?php $i = 0; ?>
	...
	?>
	<tr>
		<td colspan="7" align="center"><?php echo JText::_('CC NO EVENTS CREATED YET');?></td>
	</tr>
	<?php
		} 
	?>
