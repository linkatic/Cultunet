...
$document->addStyleSheet( $uri->root().'administrator/components/com_gk3_photoslide/interface/css/base.css', 'text/css' );
...
{	
	...
	case 'slide':
		// Including requested controller file
		require_once(JPATH_COMPONENT.DS.'controllers'.DS.'slide.php');
		// Creating new instance of controller
		$controller = new ControllerSlide();	
	break;
...
/* End of file admin.gk3_photoslide.php */
/* Location: ./admin.gk3_photoslide.php */