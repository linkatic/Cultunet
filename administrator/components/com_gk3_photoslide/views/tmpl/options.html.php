...
<?php if($modal_news == 1) : ?>	
<link rel="stylesheet" type="text/css" href="<?php echo $uri->root(); ?>administrator/components/com_gk3_photoslide/interface/css/settings.css" media="all" />	
<?php endif; ?>
...
<?php endif; ?>
	...
	<?php if($modal_news == 0) : ?>	
	<?php ViewNavigation::generate(array( JText::_("SETTINGS") => 'option=com_gk3_photoslide&c=option')); ?>
	<?php endif; ?>
		...
		<form action="index.php" method="post" name="adminForm">
			<table class="adminlist">
				...
				<tbody>
					...
					<tr>
						<td align="center"><?php echo JText::_('SLIDE_SHORTCUTS'); ?></td>
						<td align="center">
							<select name="slide_shortcuts">
								<option value="0" <?php echo ($rows['slide_shortcuts']["value"] == 0) ? 'selected="selected"' : ''; ?>><?php echo JText::_('DISABLED'); ?></option>
								<option value="1" <?php echo ($rows['slide_shortcuts']["value"] == 1) ? 'selected="selected"' : ''; ?>><?php echo JText::_('ENABLED'); ?></option>
							</select>						
						</td>
					</tr>
					<tr>
						<td align="center"><?php echo JText::_('SLIDE_WYSIWYG'); ?></td>
						<td align="center">
							<select name="wysiwyg">
					...
					<tr>
						<td align="center"><?php echo JText::_('SHOW_COLORPICKERS'); ?></td>
						<td align="center">
							<select name="colorpickers">
								<option value="0" <?php echo ($rows['colorpickers']["value"] == 0) ? 'selected="selected"' : ''; ?>><?php echo JText::_('DISABLED'); ?></option>
								<option value="1" <?php echo ($rows['colorpickers']["value"] == 1) ? 'selected="selected"' : ''; ?>><?php echo JText::_('ENABLED'); ?></option>
							</select>						
						</td>
					</tr>
					<tr>
