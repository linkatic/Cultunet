...
<link rel="stylesheet" type="text/css" href="<?php echo $uri->root(); ?>administrator/components/com_gk3_photoslide/interface/css/groups.view.css" media="all" />
			...
			<table class="adminlist">
				<thead>
					<tr>
						...
						<?php endif; ?>
						<th width="14%" class="title" align="center"><?php echo JText::_( 'NAME' ); ?></th>
						<th width="14%" class="title" align="center"><?php echo JText::_( 'MODULE' ); ?></th>
						<th width="<?php echo ($group_shortcuts == 1) ? '29%' : '49%' ?>" align="center" align="center"><?php echo JText::_( 'DESC' ); ?></th>
						<th width="14%" class="title" align="center"><?php echo JText::_( 'SLIDES_AMOUNT' ); ?></th>
					</tr>
				</thead>
				<tfoot>
					<tr>
						<td colspan="<?php echo ($group_shortcuts == 1) ? '9' : '7' ?>"><?php echo JText::_('GROUPS_FOOT_INFO'); ?></td>
					</tr>
				</tfoot>
				<tbody>
				...
				?>
					...
					<tr class="<?php echo 'row'. $i%2; ?>">
						...
						<td width="14%" align="center"><?php echo $row->type; ?></td>
				...
				<?php }}else{ // gdy brak grup do załadowania ?>
					<tr>
						<td width="100%" align="center" colspan="<?php echo ($group_shortcuts == 1) ? '9' : '7' ?>"><?php echo JText::_( 'ANY_GROUPS_TO_SHOW' ); ?></td>
					</tr>
				<?php } ?>
				</tbody>
			</table>
