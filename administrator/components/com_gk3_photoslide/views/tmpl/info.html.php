...
<?php if($modal_news == 1) : ?>	
<link rel="stylesheet" type="text/css" href="<?php echo $uri->root(); ?>administrator/components/com_gk3_photoslide/interface/css/info.css" media="all" />	
<?php endif; ?>
...
<?php endif; ?>
	...
	<?php if($modal_news == 0) : ?>	
	<?php ViewNavigation::generate(array( JText::_("INFO_AND_HELP") => 'option=com_gk3_photoslide&c=info')); ?>
	<?php endif; ?>
