...
*/
function vmMail($from, $fromname, $recipient, $subject, $body=null, $Altbody='', $mode=false, $cc=NULL, $bcc=NULL, $images=null, $attachment=null, $replyto=null ) {
	global $mosConfig_debug;
	
	//error_log('######################### Entro en vmMail()!!! BODY: '.$body.' FROM: '.$from. ' FROMNAME: '.$fromname. ' SUBJECT: '.$subject);
