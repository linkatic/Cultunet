...
JRequest :: setVar('layout', 'countries');
$_SESSION['cur_layout']='countries';
		...
		<td width="100%" valign="top">
			...
			$k = 0;
				...
				<tr valign="top" class="<?php echo "row$k"; ?>">
					...
					<td><a href="index.php?option=com_jsjobs&task=view&layout=states&ct=<?php echo $row->code; ?>"><?php echo JText::_('JS_STATES'); ?></a></td>
				</tr>
				<?php
				$k = 1 - $k;
			}
