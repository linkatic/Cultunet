 ...
 * Created on:	Jan 11, 2009
 ^
 + Project: 		JS Jobs
 * File Name:	admin-----/views/applications/tmpl/role.php
 ^ 
 * Description: Default template for role view
 ^ 
 * History:		NONE
 ^ 
 */
...
JRequest :: setVar('layout', 'roles');
$_SESSION['cur_layout']='roles';
			...
			<table class="adminlist" width="100%" >
				<thead>
					<tr>
						...
						<th  width="20%" class="title"><?php echo JText::_('JS_FOR'); ?></th>
						<th width="20% "><?php echo JText::_('JS_PUBLISHED'); ?></th>
					</tr>
				</thead>
			<?php
