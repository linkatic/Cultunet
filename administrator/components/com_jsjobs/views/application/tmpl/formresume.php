...
<table width="100%" >
	<tr>
		...
		<form action="index.php" method="post" name="adminForm" id="adminForm" enctype="multipart/form-data" class="form-validate">
				...
				<?php break;
					...
					<?php break;
						case "section_resumeeditor": ?>
							...
							<?php  echo $pane->endPanel(); ?>
							<?php echo $pane->startPanel(JText::_('JS_RESUME_EDITOR'),'resumeeditor'); ?>
								<table cellpadding="5" cellspacing="0" border="0" width="100%" class="admintable" >
									<tr>
										<td width="100" colspan="2" align="center" class="<?php echo $this->theme['sectionheading']; ?>">
							...
							<?php  if ($section_resumeeditor == 1) { ?>
								...
								<?php if (isset($this->resume)) 
											if($this->resume->filename != '') {?>
												<tr><td></td><td><a href="../components/com_jsjobs/data/jobseeker/resume_<?php echo $this->resume->id.'/resume/'.$this->resume->filename;?>"><?php echo JText::_('JS_DOWNLOAD_RESUME_FILE') .'['.$this->resume->filename.']'; ?></a></td></tr>
												<br>
			...
			<tr><td>
				<table width="100%" >
					<?php if(isset($this->resume)) {  $isodd = 1 - $isodd; ?>
