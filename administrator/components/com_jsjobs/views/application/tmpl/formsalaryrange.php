...
<table width="100%" >
	...
	?>
	 <tr>
        <td width="100%" align="center"><?php echo JText::_('JS_SALARY_RANGE_START'); ?> : 
		  &nbsp;&nbsp;&nbsp;<?php echo $this->config['currency']?><input class="inputbox required" type="text" name="rangestart" size="40" maxlength="255" value="<?php if(isset($this->application)) echo $this->application->rangestart; ?>" />
        </td>
      </tr>
	 <tr>
        <td align="center"><?php echo JText::_('JS_SALARY_RANGE_END'); ?> : 
		  &nbsp;&nbsp;&nbsp;<?php echo $this->config['currency']?><input class="inputbox required" type="text" name="rangeend" size="40" maxlength="255" value="<?php  if(isset($this->application)) echo $this->application->rangeend; ?>" />
        </td>
      </tr>
	...
	<tr>
		...
		<input type="submit" name="submit_app" onclick="return validate_form(document.adminForm)" value="<?php echo JText::_('JS_SAVE_SALARY_RANGE'); ?>" />
			...
			<input type="hidden" name="task" value="savesalaryrange" />
