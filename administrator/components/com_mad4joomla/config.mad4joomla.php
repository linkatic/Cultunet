<?PHP
define('M4J_EMAIL_ROOT', 'info@gestionycultura.com' );
...
define('M4J_FROM_NAME', 'Contacto - cultunet.com' );
define('M4J_FROM_EMAIL', 'info@cultunet.com' );
define('M4J_HELP_ICON', 0 );
define('M4J_HTML_MAIL', true );
define('M4J_SHOW_LEGEND', true );
define('M4J_CAPTCHA', 'SIMPLE' );
