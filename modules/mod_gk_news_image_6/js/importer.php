...
/**
* Gavick News Image VI - JavaScript importer
* @package Joomla!
...
$Gavick["gk_news_image_6-<?php echo $_GET['mid'];?>"] = {
	...
	"thumb_w":<?php echo $_GET['thumbnail_width'];?>,
	"thumb_h":<?php echo $_GET['thumbnail_height'];?>,
	"t_amount":<?php echo $_GET['tabs_amount'];?>,
