  ...
  <tr> 
    <td colspan="2">
      ...
      <form action="<?php echo $mm_action_url."index.php" ?>" method="get">
		...
		?><?php /** Changed Product Type - Begin */

	if ( $show_product_parameter_search == 'yes' ) { ?>
        <br />
		<?php //Enlace anterior -> index.php?option=com_virtuemart&page=shop.parameter_search&product_type_id=1 ?>
        <a href="<?php echo $sess->url($mm_action_url."?page=shop.parameter_search_form&product_type_id=1") ?>" title="<?php echo $VM_LANG->_('PHPSHOP_PARAMETER_SEARCH') ?>">
