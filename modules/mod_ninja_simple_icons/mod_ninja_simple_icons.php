...
// Lets include all the params
  ...
  // The params in the array are = 0-icon_status 1-icon_img, 2-icon_title, 3-icon_link, 4-icon_alt
   $iconParams = array (
		array($params->get('icon1_status'),$params->get('icon1_img'),$params->get('icon1_title'),$params->get('icon1_link'),$params->get('icon1_alt'),$params->get('icon1_target'), $params->get('icon1_img_over')),
...
<script language="javascript">
	...
	window.addEvent('domready', function() {
		$('menuhxdmenu-icons2').addEvent("mouseover", function(){
			var a = document.getElementById('hxdmenu');
			var b = a.getElementsByTagName('li')[3];
			//a.style.width = '100px';
			//b.style.width = '1000px';
			b.getElementsByTagName('ul')[0].style.left = '0';
			b.getElementsByTagName('ul')[0].style.top = '25px';
		});
		$('menuhxdmenu-icons2').addEvent("mouseout", function(){
			var a = document.getElementById('hxdmenu');
			var b = a.getElementsByTagName('li')[3];
			//a.style.width = '100px';
			//b.style.width = '1000px';
			b.getElementsByTagName('ul')[0].style.left = '';
			b.getElementsByTagName('ul')[0].style.top = '';
		});
		
		$('menuhxdmenu-icons9').addEvent("mouseover", function(){
			var a = document.getElementById('hxdmenu');
			var b = a.getElementsByTagName('li')[16];
			//a.style.width = '100px';
			//b.style.width = '1000px';
			b.getElementsByTagName('ul')[0].style.left = '0';
			b.getElementsByTagName('ul')[0].style.top = '25px';
		});
		$('menuhxdmenu-icons9').addEvent("mouseout", function(){
			var a = document.getElementById('hxdmenu');
			var b = a.getElementsByTagName('li')[16];
			//a.style.width = '100px';
			//b.style.width = '1000px';
   ...
   <div>
    <ul>                
       <?php /* loop through our menu items and display the ones we need to display */ 
        ...
        ?>
               <li <?php echo $active; ?>>
                  <a class="linkopacity" href="<?php echo $iconParams[$i][3]; ?>" target="<?php echo $iconParams[$i][5]; ?>">
                  <img id="menuhxdmenu-icons<?php echo $i; ?>" src="<?php echo $siteLoc.'/images/'.$iconParams[$i][1] ?>" title="<?php echo $iconParams[$i][2]; ?>" alt="<?php echo $iconParams[$i][4]; ?>" height="<?php echo $icon_height; ?>" width="<?php echo $icon_width; ?>" />
