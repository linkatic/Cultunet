...
class GKNewsImage1Helper{
	...
	**/
	...
	function initialize(&$params)
	{
		...
		$this->wrapper_border = $params->get('wrapper_border', 0);//
		$this->wrapper_border_color = $params->get('wrapper_border_color', '#000');//
		...
		$this->text_block_position = $params->get('text_block_position', 1);//
		...
		$this->outter_interface = $params->get('outter_interface', 0);
		$this->outter_interface_width = $params->get('outter_interface_width', 24);
		$this->outter_readmore = $params->get('outter_readmore', 1);
	...
	function getDatas()
	{
		...
		if( $dane = $database->loadObjectList() )
		{
			foreach($dane as $item)
			{
				...
				$this->slide_width = $item->mediumThumbX;
				if($this->module_height == 0) $this->module_height = $item->mediumThumbY;
				$this->slide_height = $item->mediumThumbY;
	...
	**/
	...
	{		
		...
		$querystring = '?text_block_width='.$this->text_block_width.'&amp;text_block_opacity='.$this->text_block_opacity.'&amp;text_block_margin='.$this->text_block_margin.'&amp;module_width='.$this->module_width.'&amp;module_height='.$this->module_height.'&amp;thumbnail_bar='.$this->thumbnail_bar.'&amp;thumbnail_width='.$this->thumbnail_width.'&amp;thumbnail_height='.$this->thumbnail_height.'&amp;thumbnail_margin='.$this->thumbnail_margin.'&amp;thumbnail_border='.$this->thumbnail_border.'&amp;thumbnail_bar_position='.$this->thumbnail_bar_position.'&amp;image_x='.$this->image_x.'&amp;image_y='.$this->image_y.'&amp;slides_count='.count($this->slides).'&amp;tick_x='.$this->tick_x.'&amp;tick_y='.$this->tick_y.'&amp;modid='.$this->module_id.'&amp;thumbnail_border_color_inactive='.substr($this->thumbnail_border_color_inactive, 1).'&amp;base_bgcolor='.substr($this->base_bgcolor, 1).'&amp;text_block_position='.$this->text_block_position.'&amp;text_block_height='.$this->text_block_height.'&amp;outter_interface='.$this->outter_interface.'&amp;outter_interface_width='.$this->outter_interface_width.'&amp;wrapper_border='.$this->wrapper_border.'&amp;text_block_background='.$this->text_block_background.'&amp;text_block_bgcolor='.substr($this->text_block_bgcolor, 1).'&amp;slide_width='.$this->slide_width.'&amp;slide_height='.$this->slide_height.'&amp;image_x='.$this->image_x.'&amp;image_y='.$this->image_y.'&amp;interface_x='.$this->interface_x.'&amp;interface_y='.$this->interface_y;
		// ---------------------------------------------------------
