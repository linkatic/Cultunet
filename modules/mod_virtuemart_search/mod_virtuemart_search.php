...
?>
<!--BEGIN Search Box --> 
<div class="border-container bg-container" style="padding:15px">
<form action="<?php $sess->purl( $mm_action_url."index.php?page=shop.browse" ) ?>" method="post">
	...
	<p>
		...
		<input class="button" style="margin-top:10px" type="submit" name="Search" value="<?php echo $VM_LANG->_('PHPSHOP_SEARCH_TITLE') ?>" />
	</p>
</form>
<!-- End Search Box --> 
</div>