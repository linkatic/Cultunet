...
$playerFile		= JURI::root() . 'components/com_community/assets/flowplayer/flowplayer-3.2.2.swf';
$playerScript	= JURI::root() . 'components/com_community/assets/flowplayer/flowplayer-3.2.2.min.js';
$playerPlugin	= JURI::root() . 'components/com_community/assets/flowplayer/flowplayer.pseudostreaming-3.2.2.swf';
$playerControl	= JURI::root() . 'components/com_community/assets/flowplayer/flowplayer.controls-3.2.1.swf';
$embedScript	= JURI::root() . 'components/com_community/assets/flowplayer/flowplayer.embed-3.0.3.js';
...
<script type="text/javascript" src="<?php echo $embedScript; ?>"></script>
