    ...
    <div class="cSidebar clrfix">
        ...
        <div id="community-event-action" class="cModule">
            ...
            <ul class="event-menus clrfix">
                ...
                <!-- Edit Event -->
                <li class="event-menu">
                    <a class="event-edit-info" href="<?php echo CRoute::_('index.php?option=com_community&view=events&task=edit&eventid=' . $event->id );?>"><?php echo JText::_('CC EDIT EVENT');?></a>
                </li>
                <?php } ?>
        ...
        <div id="community-event-admins" class="cModule">
            ...
            <div class="app-box-footer">
            <?php if( $accessAllowed ){ ?>
                <a href="<?php echo CRoute::_('index.php?option=com_community&view=events&task=viewguest&eventid=' . $event->id . '&type=' . COMMUNITY_EVENT_ADMINISTRATOR );?>">
        ...
        <!-- Event Summary -->
        <!--
        <div id="community-event-summary" class="cModule">
