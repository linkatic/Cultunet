...
<div id="<?php echo 'jsapp-' . $app->id; ?>" class="cModule<?php if($app->core) echo " app-core";  ?> app-widget">
	...
	<div class="app-widget-header">
		...
		<a title="<?php echo JText::_('CC EDIT');?>" href="javascript:void(0);" class="editprofilelink" onclick="joms.apps.showSettingsWindow('<?php echo $app->id;?>','<?php echo $app->name;?>');"></a>
		<?php } ?>
	</div>
