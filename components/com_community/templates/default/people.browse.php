...
?>
		<div class="featured-items">
			...
			<div style="font-weight: bold; text-align: center; white-space: nowrap; overflow: hidden; padding: 3px 10px;"><?php echo $user->getDisplayName(); ?></div>
<?php
		if( $isCommunityAdmin )
		{
?>
			...
			<div class="mini-profile-details">
				...
				<div class="mini-profile-details-action">
				    <span class="icon-group">
				    	<?php echo JText::sprintf( (CStringHelper::isPlural($row->friendsCount)) ? 'CC FRIENDS COUNT MANY' : 'CC FRIENDS COUNT', $row->friendsCount);?>
				    </span>
...
<?php
	...
	{
?>
		<div class="advance-not-found"><?php echo JText::_('CC NO RESULT FOUND');?></div>
<?php
	}
?>