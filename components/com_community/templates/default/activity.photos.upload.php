...
<ul class ="cDetailList clrfix">
	...
	{
		$aact 		= $acts[$i];
		$aparam		= new JParameter( $aact->params );
	...
	?>
	<li class="avatarWrap">
		<a href="<?php echo $photo->getPhotoLink();?>"><img alt="<?php echo $this->escape($photo->caption);?>" src="<?php echo $photo->getThumbURI();?>" class="avatar"/></a>
	</li>
	<?php
	}
	?>
