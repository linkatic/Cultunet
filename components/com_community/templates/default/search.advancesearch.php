									...
									?>		
											case "<?php echo $field->fieldcode; ?>":
												...
												<?php } else { ?>
													...
													{
													?>			
														list +='<option value="<?php echo JText::_(addslashes(JString::trim($data)))?>"><?php echo JText::_(addslashes(JString::trim($data))); ?></option>';
													<?php
													}
													?>
													list +='</select>';
...
<form name="jsform-search-advancesearch" action="" accept-charset="utf-8" method="GET">
