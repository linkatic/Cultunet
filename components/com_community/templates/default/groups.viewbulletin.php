    ...
    <div class="buletin-detail">
        ...
        <div id="bulletin-edit-data" style="display: none;">
            <form name="addnews" method="post" action="<?php echo CRoute::_('index.php?option=com_community&view=groups&task=editnews'); ?>">
                <div>
                    <label style="font-weight: 700;" for="title"><?php echo JText::_('CC BULETIN FORM TITLE');?></label>
                </div>
                <input type="text" value="<?php echo $bulletin->title;?>" id="title" name="title" class="inputbox" style="width: 94%; margin: 10px 0;" />
                
                <div>
                    <label style="font-weight: 700;" for="description"><?php echo JText::_('CC BULETIN FORM DESCRIPTION');?></label>
                </div>
            ...
            <?php echo $editor->display( 'message',  $editorMessage , '95%', '450', '10', '20' , false ); ?>
            <?php
                }
                else
                {
            ...
            <div style="text-align: center; padding-top: 20px;">
                ...
                <input type="submit" value="<?php echo JText::_('CC BUTTON SAVE'); ?>" class="button" onclick="saveContent();" />
                <input type="button" class="button" onclick="joms.groups.editBulletin();return false;" value="<?php echo JText::_('CC BUTTON CANCEL'); ?>" />
            </div>
            </form>
        </div>
        <!--Buletin : Edit Entry-->
