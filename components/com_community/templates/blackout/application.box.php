		...
		<div class="app-box-header">
			...
			<div class="app-box-menus">
				<div class="app-box-menu toggle">
					<a class="app-box-menu-icon" href="javascript: void(0)" onclick="joms.apps.toggle('#<?php echo 'jsapp-' . $app->id; ?>');"><span class="app-box-menu-title"><?php echo JText::_('CC EXPAND');?></span></a>
				</div>
