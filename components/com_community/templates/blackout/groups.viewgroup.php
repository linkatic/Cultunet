		...
		<?php } // if( $group->approvals == '0' || $isMine || $isMember || $isCommunityAdmin ) ?>
			...
			<div id="community-group-side-photos" class="cModule">
					...
					<div class="clrfix">
						...
						<img class="avatar jomTips" title="<?php echo $this->escape($album->name);?>::<?php echo $this->escape( $album->description );?>" src="<?php echo $album->thumbnail;?>" alt="<?php echo $this->escape($album->name);?>" />
						</a>
						<?php } ?>
						</div>
    ...
    <div class="cMain clrfix">
		...
		<div id="community-group-videos" class="app-box">
            ...
            <div class="app-box-header">           
                ...
                <div class="app-box-menus">
                    <div class="app-box-menu toggle">
                        <a class="app-box-menu-icon" href="javascript: void(0)" onclick="joms.apps.toggle('#community-group-videos');">
                            <span class="app-box-menu-title"><?php echo JText::_('CC EXPAND');?></span>
                        </a>
                    </div>
                </div>
            ...
            <?php if($videos) { ?>
                <!--VIDEO ITEMS-->
                <ul class="video-items cResetList">
            <?php foreach( $videos as $video ) { ?>
                
            	<li id="<?php echo "video-" . $video->id ?>">
            	
            		<!--VIDEO ITEM-->
            		<div class="video-item jomTips" title="<?php echo $video->title . '::' . $this->escape($video->description); ?>">
            			...
            			<a class="video-thumb-url" href="<?php echo $video->url; ?>" style="width: <?php echo $videoThumbWidth; ?>px; height:<?php echo $videoThumbHeight; ?>px;">
            			  <img src="<?php echo $video->thumb; ?>" style="width: <?php echo $videoThumbWidth; ?>px; height:<?php echo $videoThumbHeight; ?>px;" alt="<?php echo $this->escape( $video->title ); ?>" />
            			</a>
