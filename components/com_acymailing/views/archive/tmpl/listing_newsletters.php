		...
		<tbody>
			...
			?>
				<tr class="<?php echo "sectiontableentry$k".$this->values->suffix; ?>">
					...
					<td>
						<a <?php if($this->config->get('open_popup')){ echo 'class="modal" rel="{handler: \'iframe\', size: {x: 750, y: 550}}"'; } ?> href="<?php echo acymailing::completeLink('archive&task=view&listid='.$this->list->listid.'-'.$this->list->alias.'&mailid='.$row->mailid.'-'.strip_tags($row->alias),(bool)$this->config->get('open_popup')); ?>">
