...
echo '<table style="width:auto; margin:0 auto;background: url( \''. VM_THEMEURL .'images/checkout/checkout'. $step_count.'_'.$current_step .'.png\' ) top right; background-repeat: no-repeat; height:115px;text-align:center;" border="0" cellspacing="0" cellpadding="0" align="center">
  <tr>';
