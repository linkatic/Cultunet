...
<?php 
$link = JRoute::_('tienda?page=account.billing&next_page=checkout.index');
if(!$db->f("first_name") || !$db->f("last_name") || !$db->f("address_1") || !$db->f("city") || !$db->f("zip") || !$db->f("country_name") || !$db->f("state_2_code") || !$db->f("phone_1")) {
