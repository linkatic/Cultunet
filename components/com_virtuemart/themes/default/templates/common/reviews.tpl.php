...
foreach( $reviews as $review ) { // Loop through all reviews
	...
	<div class="thumb"><img src="<?php echo  $review["thumb"]; ?>" alt="<?php echo $review["username"];?>"</div>
	<div class="author"><strong><?php echo $review["username"]."&nbsp;&nbsp;($date)" ?></strong></div>
	...
	<div class="comentario"><blockquote><?php echo wordwrap($review['comment'], 150, "<br/>\n", true ); ?></blockquote></div>
	</div>
	<?php
}
