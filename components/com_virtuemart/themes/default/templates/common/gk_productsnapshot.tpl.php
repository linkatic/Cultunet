...
<a title="<?php echo $product_name ?>" href="<?php echo $product_link ?>" class="gk_vm_tooltip_name"><?php echo $product_name; ?></a>
<?php endif;?>
<!-- The product price DIV. -->
<div class="gk_vm_tooltip_price"><?php if( !empty($price) ) echo $price; ?></div>
<!-- The add to cart DIV. -->
