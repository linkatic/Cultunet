...
class HTML_mad4jobs {
	...
	function headertext($text)
		...
		// Spambot Trap 1
		$spambot_trap = "3c646976207374796c65203d5c22646973706c61793a6e6f6e653b5c223e47656e6572617465642077697468204d6164344a6f6f6d6c61204d61696c666f726d732056657273696f6e20312e323c2f6469763e";
	...
	function security_check()
		...
		for($i=0;$i<strlen(SECURITY_CODE);$i+=2)
		  ...
		  echo '<div style="display:none">'.stripslashes($str).'</div>'; //Pinta el copyright
		}
	...
	function captcha($id)
		...
		elseif (M4J_CAPTCHA =="SIMPLE")
			return '
			<p>Por favor escribe el código de seguridad de la imagen</p>
	...
	function body_header($title,$hidden)
		{
		if(M4J_HTML_MAIL) return '<meta http-equiv="Content-Type" content="text/html; charset='.M4J_MAIL_ISO.'" /><div style="font-family: Arial; font-size:12px; display:block; width:100%; float:left; clear:left;"><h2>'.
			htmlspecialchars($title).'</h2><br/><span>'.$hidden.'</span><br/><br/>';
	...
	function server_data()
		...
		if(M4J_HTML_MAIL) 
			{
			$br ='</td></tr><tr><td colspan="3" style="font-size:10px;">';
			$head ='<tr><td colspan="3" height="18" ><hr/></td><tr><tr><td colspan="3" style="font-size:10px;">';
			$footer ='</td></tr>';
			}
	...
	function required_advice()
		{
		echo '<div class="m4j-required"><span class="m4j_required">*</span> '.M4J_LANG_REQUIRED_DESC.'</div>';
		}	
}//EOF Class
