...
<form method="post" action="<?php echo JRoute::_('index.php?option=com_rsmembership&task=renewpaymentredirect'); ?>" name="membershipForm">
...
<input type="submit" class="button" value="<?php echo JText::_('RSM_RENEW'); ?>" name="Submit" />

<?php echo $this->token; ?>
<input type="hidden" name="option" value="com_rsmembership" />
<input type="hidden" name="view" value="renew" />
<input type="hidden" name="task" value="renewpaymentredirect" />
