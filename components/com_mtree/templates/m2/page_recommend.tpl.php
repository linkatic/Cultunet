...
<h2 class="contentheading"><?php echo JText::_( 'Recommend listing to friend' ) . ' - ' . $this->link->link_name; ?></h2>
...
<table border="0" cellpadding="3" cellspacing="0" width="100%">
	...
	<tr>
		<td colspan="2">
			<b><?php echo JText::_( 'To' ) ?>:</b>
		</td>
	</tr>
	<tr>
		<td><?php echo JText::_( 'Friends name' ) ?>:</td>
		<td><input type="text" name="friend_name" class="inputbox" size="40" /></td>
	</tr>
	<tr>
		<td><?php echo JText::_( 'Friends email' ) ?>:</td>
	...
	<tr>
		<td colspan="2">
			...
			<input type="button" value="<?php echo JText::_( 'Send' ) ?>" onclick="javascript:submitbutton('send_recommend')" class="button" /> <input type="button" value="<?php echo JText::_( 'Cancel' ) ?>" onclick="javascript:submitbutton('cancel')" class="button" />
		</td>
	</tr>
</table>
</form>
