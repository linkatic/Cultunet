...
<table cellpadding="0" cellspacing="0" border="0" width="100%" class="contentpane">
	...
	<tr><td class="curloc">
		<?php echo JText::_('JS_CUR_LOC'); ?> : <?php echo JText::_('JS_JOB_SAVE_SEARCHES'); ?>
	</td></tr>
	<?php } ?>
	<tr><td>
		<?php 
		...
		$i=0;
			...
			$i++;
				...
				<tr height="20" class="<?php echo $tdclass[$isodd]; ?>" > 
					...
					<td class="maintext" align="center" valign="middle"><a href="index.php?option=com_jsjobs&c=jsjobs&view=jobseeker&layout=viewjobsearch&js=<?php echo $search->id; ?>">
						<img width="15" height="15" src="components/com_jsjobs/images/view.png" /></td>
					<td class="maintext" align="center" valign="middle">
							<a href="index.php?option=com_jsjobs&c=jsjobs&task=deletejobsearch&js=<?php echo $search->id; ?>&Itemid=<?php echo $this->Itemid; ?>">
