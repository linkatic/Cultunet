...
<table cellpadding="0" cellspacing="0" border="0" width="100%" class="contentpane">
	...
	<tr><td class="curloc">
		<?php $vm = $this->vm; 
			if ($vm == '1'){ //my resume ?> 
			<?php echo JText::_('JS_CUR_LOC'); ?> : <a href="index.php?option=com_jsjobs&c=jsjobs&view=jobseeker&layout=myresumes&Itemid=<?php echo $this->Itemid; ?>" class="curloclnk" ><?php echo JText::_('JS_MY_RESUME'); ?></a> > <?php echo JText::_('JS_VIEW_RESUME'); ?>
		<?php }elseif ($vm == '2'){ //view resume ?> 
...
$printform = 1;
	...
	if ((isset($this->resume)) &&($this->resume->id != 0)) { // not new form
		if ($this->resume->status == 1) { // Employment Application is actve
			...
			$printform = 0;
			echo "<font color='red'><strong>" . JText::_('JS_RESUME_WAIT_APPROVAL') . "</strong></font>";
		} else{ // not allowed job posting
			$printform = 0;
			echo "<font color='red'><strong>" . JText::_('JS_RESUME_REJECT') . "</strong></font>";
		}
		if ($vm == 1){
...
<div id="form-jobseeker">
			...
			<?php if (($vm == '2') || ($vm == '3')) { ?>
			<?php  $jobid = $this->bd;
			$clink = 'index.php?option=com_jsjobs&c=jsjobs&view=jobseeker&layout=view_coverletters&vts=1&clu='.$this->resume->uid.'&rd='.$this->resume->id.'&bd='.$jobid.'&Itemid='.$this->Itemid; ?>
							...
							<?php  if (($section_education == 1) && ($section_sub_institute3 == 1)) { ?>
								<tr class="<?php echo $this->theme[$trclass[$isodd]]; ?>">
									...
									<td id="institute3_county">
										<?php if ($this->resume2->institute3_county2 !='') echo $this->resume2->institute3_county2; else echo $this->resume->institute3_county;?>
									</td>
								</tr>
							<?php } ?>
					<?php break;
						...
						case "employer_county":  $isodd = 1 - $isodd; ?>
							...
							<tr class="<?php echo $this->theme[$trclass[$isodd]]; ?>">
								...
								<td id="employer_county">
										<?php if ($this->resume2->employer_county2 !='') echo $this->resume2->employer_county2; else echo $this->resume->employer_county;?>
								</td>
							</tr>
							<?php } ?>
					<?php break;
						...
						case "reference_state":  $isodd = 1 - $isodd; ?>
							...
							<tr class="<?php echo $this->theme[$trclass[$isodd]]; ?>">
								...
								<td id="reference_state">
										<?php if ($this->resume3->reference_state2 !='') echo $this->resume3->reference_state2; else echo $this->resume3->reference_state;?>
								</td>
							</tr>
							<?php } ?>
					<?php break;
						case "reference_county":  $isodd = 1 - $isodd; ?>
							...
							<tr class="<?php echo $this->theme[$trclass[$isodd]]; ?>">
								...
								<td id="reference_county">
										<?php if ($this->resume3->reference_county2 !='') echo $this->resume3->reference_county2; else echo $this->resume3->reference_county;?>
								</td>
							</tr>
							<?php } ?>
					<?php break;
						case "reference_city":  $isodd = 1 - $isodd; ?>
							...
							<tr class="<?php echo $this->theme[$trclass[$isodd]]; ?>">
						        ...
						        <td id="reference_city">
										<?php if ($this->resume3->reference_city2 !='') echo $this->resume3->reference_city2; else echo $this->resume3->reference_city;?>
								</td>
							</tr>
							<?php } ?>
					<?php break;
			...
			?>
<?php
	}else echo JText::_('JS_RESULT_NOT_FOUND'); 
}
}//ol
