...
<table cellpadding="0" cellspacing="0" border="0" width="100%" class="contentpane">
	...
	<tr><td class="curloc">
		<?php echo JText::_('JS_CUR_LOC'); ?> : <?php echo JText::_('JS_MY_COVER_LETTERS'); ?>
	</td></tr>
	<?php } ?>
	<tr><td>
		<?php 
		...
		$i=0;
			...
			$i++;
				...
				<tr height="30" class="<?php echo $tdclass[$isodd]; ?>" > 
					...
					<td class="maintext" align="center" valign="middle"><a href="index.php?option=com_jsjobs&c=jsjobs&view=jobseeker&layout=view_coverletter&vct=1&cl=<?php echo $letter->id; ?>">
						<img width="15" height="15" src="components/com_jsjobs/images/view.png" />
					</td>
					<td class="maintext" align="center" valign="middle"><a href="index.php?option=com_jsjobs&c=jsjobs&view=jobseeker&layout=formcoverletter&cl=<?php echo $letter->id; ?>">
						<img width="15" height="15" src="components/com_jsjobs/images/edit.png" />
					</td>
					<td class="maintext" align="center" valign="middle">
							<a href="index.php?option=com_jsjobs&c=jsjobs&task=deletecoverletter&cl=<?php echo $letter->id; ?>">
