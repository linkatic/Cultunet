...
$string['allowblockstodock'] = 'Permitir que los bloques utilicen el \'dock\'';
...
$string['configcreatornewroleid'] = 'Este rol es automáticamente asignado a los creadores de un nuevo curso. Este rol no es asignado si el creador ya tiene las capacidades necesarias en un contexto superior.';
...
$string['uploadusers_help'] = '<p>En primer lugar tenga en cuenta que <strong>normalmente no es necesario importar
