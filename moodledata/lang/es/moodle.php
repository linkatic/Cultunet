...
$string['backupnoneusersinfo'] = 'Nota: Esta copia de seguridad no contiene usuarios, de modo que todas las actividades se han señalado como "sin datos de usuario". Las actividades de Ejercicio y Taller no se incluirán en la copia de seguridad, puesto que estos módulos no son compatibles con este tipo de copia.';
...
$string['expirynotifystudents_help'] = '<p>Avisar también a los estudiantes</p>';
$string['expirythreshold'] = 'Umbral';
$string['expirythreshold_help'] = '<p>Umbral de notificación del término del plazo de matriculación</p>';
...
$string['forcepasswordchangecheckfull'] = '¿Está absolutamente seguro de que quiere forzar un cambio de contraseña a {$a} ?';
...
$string['frontpagedescription'] = 'Descripción de la portada';
...
$string['rsserrorauth'] = 'Su enlace RSS no contiene una ficha de autenticación válida.';
...
$string['showreports_help'] = '<P>Los informes de actividades están disponibles para todos
...
$string['uploadfilecontainerror'] = 'El archivo subido no ha podido procesarse debido al error o errores especificados. Por favor, corrija el archivo antes de subirlo de nuevo.';
$string['uploadfilecontentsnovaliddata'] = 'El archivo subido contiene datos no válidos.';
...
$string['uploadinvalidpreprocessedcount'] = 'Número de registros preprocesados no válidos: {$a}';
