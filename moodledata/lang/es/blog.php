...
$string['blog'] = 'Blog';
$string['blogaboutthis'] = 'Blog sobre este asunto {$a->type}';
$string['blogaboutthiscourse'] = 'Agregar una entrada sobre este curso';
$string['blogaboutthismodule'] = 'Agregar una entrada sobre este asunto {$a}';
...
$string['viewmyentriesaboutcourse'] = 'Ver mis entradas sobre este curso';
