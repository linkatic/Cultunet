...
$string['activitycompletionreport'] = 'Informe de progreso de finalización de actividad';
...
$string['completionexpected_help'] = 'Esta opción especifica la fecha en que se espera que la actividad esté completada. La fecha no se muestra a los estudiantes y aparece únicamente en el informe de progreso.';
...
$string['completionreport'] = 'Informe de progreso de la finalización';
...
$string['completionstartonenrolhelp'] = 'Comenzar el rastreo del profeso de un estudiante en el grado de finalización del curso después de la matriculación en el curso';
...
$string['configprogresstrackedroles'] = 'Roles que se muestran en la pantalla de progreso-rastreo. (Normalmente se incluyen los estudiantes y los roles equivalentes).';
...
$string['coursecompletionreport'] = 'Informe del progreso del grado de finalización del curso';
