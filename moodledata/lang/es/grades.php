...
$string['aggregation_help'] = '<p>Este menú le permite elegir la estrategia de agregación que se usará para calcular la puntuación global de cada participante en esta categoría. Las distintas opciones se explican en la tabla siguiente.</p>
...
$string['aggregationposition_help'] = '<p>Define la posición de la columna total de agregación en el informe relacionado con las calificaciones que están siendo agregadas.</p>';
...
$string['droplow_help'] = '<p>Si se activa, esta opción descartará las X calificaciones más bajas, 
...
$string['gradedisplaytype_help'] = '<p>Especifica como se verán las calificaciones en el calificador y reportes de usuario. 
...
$string['grademax_help'] = '<p>Cuando se use el tipo de calificación por valor, una calificación máxima puede ser establecida.
...
$string['grademin_help'] = '<p>Cuando se use el tipo de calificación por valor, una calificación mínima puede
   ser establecida.</p>';
...
$string['multfactor_help'] = '<p>Es el factor por la que todas las calificaciones para este ítem de 
...
$string['plusfactor_help'] = '<p>Número que será sumado a cada calificación para este ítem de calificación, 
...
$string['showhiddenitems_help'] = 'Mostrar ítems ocultos en el informe incluso si el usuario no tiene permiso moodle/grade:viewhidden. La visibilidad de las calificaciones ocultas no se ve afectada por este ajuste.';
...
$string['showrank_help'] = 'Mostrar rango de cada ítem.';
...
$string['typescale_help'] = '<p>Cuando se utilice el tipo de calificación escala, una escala puede ser seleccionada. 
