...
$string['eachattemptbuildsonthelast_help'] = '<p>Si se permiten varios intentos y se selecciona <B>Sí</B>, cada nuevo intento
...
$string['shufflewithin_help'] = '<p>Si habilita esta opción, las partes que componen las preguntas individuales serán barajadas aleatoriamente cada vez que un estudiante comienza a contestar el cuestionario, suponiendo que la opción también esté habilitada en los ajustes de la pregunta.</p>
...
$string['timelimit_help'] = '<p align="center"><strong>Límite de tiempo</strong></p>
