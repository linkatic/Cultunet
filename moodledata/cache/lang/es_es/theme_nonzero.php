<?php $this->cache['es_es']['theme_nonzero'] = array (
  'pluginname' => 'Nonzero',
  ...
  'configtitle' => 'Nonzero Settings',
  'customcss' => 'Custom CSS',
  'customcssdesc' => 'Any CSS you enter here will be added to every page allowing your to easily customise this theme.',
  'regionprewidth' => 'Left column width',
  'regionprewidthdesc' => 'This sets the width of the block region that forms the left column. This column is displayed in the middle of the page while using blog layout',
  'regionpostwidth' => 'Right column width',
  'regionpostwidthdesc' => 'This sets the width of the block region that forms the right column.',
);