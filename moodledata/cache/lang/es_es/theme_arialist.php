<?php $this->cache['es_es']['theme_arialist'] = array (
  'pluginname' => 'Arialist',
...
<div class="clearfix">
  ...
  'linkcolordesc' => 'This sets the link color for the theme.',
  'configtitle' => 'Arialist settings',
  'customcss' => 'Custom CSS',
  'customcssdesc' => 'Any CSS you enter here will be added to every page allowing your to easily customise this theme.',
  'tagline' => 'Tagline',
  'taglinedesc' => 'A short tagline to be displayed under the site name on the front page.<br /><em>(Will not be displayed with logo.)</em>',
  'logo' => 'Logo',
  'logodesc' => 'Enter the URL to an image to use as the logo for this site. Should be http://www.yoursite.com/path/to/logo.png',
