<?php $this->cache['es_es']['enrol_meta'] = array (
  ...
  'nosyncroleids_desc' => 'By default all course level role assignments are synchronised from parent to child courses. Roles that are selected here will not be included in the synchronisation process. The current roles will be updated in the next cron execution.',
