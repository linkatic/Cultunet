 ...
 * @version     1.9.7
 *
 * @author      Peter van Westen <peter@nonumber.nl> and Stephen Brandon <stephen@brandonitconsulting.co.uk>
 * @link        http://www.nonumber.nl and http://www.metamodpro.com
 * @copyright   Copyright (C) 2010 NoNumber! and Brandon IT Consulting; All Rights Reserved
...
class JModuleHelper
{
	...
	function renderModule( $module, $attribs = array() )
	{
		...
		// onRenderModule is allowed to alter the $module,
		...
		$result = $mainframe->triggerEvent( 'onRenderModule', array( &$module ) );
		if ( array_search( true, $result ) !== false ) {
			return '';
		}
